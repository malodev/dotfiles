...
keymap.set('i', '<C-c>', '<ESC>',  { desc = 'Make CTRL + C behave exactly the same as ESC', silent = true, noremap = true })
...
keymap.set('n', '<leader>bp', ':BufferLineTogglePin<CR>', { desc="Pin current buffer", silent = true, noremap = true })
