import type { Blocker, ForgeTask, NextAction, RunPhase, RunSnapshot, TaskRuntimeState, TestSpecEntry, TddPhase } from "./types";
...
export type ForgeEvent =
  ...
  | { type: "task_runtime_updated"; at: string; taskId: string; retries?: number; error?: string | null; failureSignature?: string | null; stallWarnedAt?: string | null; diagnostic?: { classification: string; notes: string } | null; diagnosticCount?: number | null }
  ...
  | { type: "human_intervention_resolved"; at: string; taskId: string; resolution: string }
