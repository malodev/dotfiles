...
## Phase Instructions
You are in GREEN. Make the smallest implementation change required to turn validation green. Do not refactor yet.

## Validation Command
node --test --experimental-strip-types tests/integration/replay-regression-suite.test.ts

## Previous Feedback
RED established successfully. Validation is failing as expected. Move to GREEN.

$ node --test --experimental-strip-types tests/integration/replay-regression-suite.test.ts
exit: 1
▶ Replay regression suite
  ✔ status before restart equals status after replay (7.04875ms)
  ✔ patched human intervention -> requeued -> executable (2.324458ms)
  ✔ executing with no running tasks and ready tasks -> execution can continue (1.292875ms)
  ✔ failed dependency requeue clears downstream dependency blockers through replay (1.17075ms)
  ✔ execute and resume use the same transition policy (0.110084ms)
  ✖ rejects unsafe validation patch commands before planning retry events (1.398416ms)
✖ Replay regression suite (14.397458ms)
ℹ tests 6
ℹ suites 1
ℹ pass 5
ℹ fail 1
...
ℹ skipped 0
ℹ todo 0
ℹ duration_ms 115.896125

✖ failing tests:

test at tests/integration/replay-regression-suite.test.ts:170:3
✖ rejects unsafe validation patch commands before planning retry events (1.398416ms)
  AssertionError [ERR_ASSERTION]: unsafe validation command should be rejected before planning events
  
  true !== false
  
      at TestContext.<anonymous> (file:///Users/mauro/dotfiles/pi/dev/task-forge/tests/integration/replay-regression-suite.test.ts:190:12)
