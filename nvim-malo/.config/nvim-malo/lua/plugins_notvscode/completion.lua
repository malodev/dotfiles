...
return {
  {
    ...
    dependencies = {
      ...
      -- Add CodeCompanion as a dependency so it loads before Blink
    ...
    opts = {
      ...
      sources = {
        ...
        providers = {
          ...
          -- NOTE: You don't need to manually define codecompanion provider here
          -- CodeCompanion registers it automatically when loaded
        },
      },
    },
