...
declare -A GROUP_DESC=(
    ...
    ["web-cli"]="Terminal web browsers (w3m, Lynx)"
...
declare -A GROUP_DETAIL_LINE_2=(
    ...
    ["web-cli"]="Installs: w3m/lynx where applicable via __PACKAGE_MODE__"
...
declare -A GROUP_DETAIL_LINE_3=(
    ...
    ["web-cli"]="Remote note: excluded from --ssh by default"
