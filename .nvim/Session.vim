...
badd +83 ~/dotfiles/nvim-test/.config/nvim-test/lua/config/keymaps.lua
badd +1 ~/dotfiles/nvim-test/.config/nvim-test/lua/config/plugins/codeium.lua
badd +47 ~/dotfiles/nvim-test/.config/nvim-test/lua/config/plugins/completion.lua
...
badd +16 ~/dotfiles/nvim-test/.config/nvim-test/lua/config/plugins/lualine.lua
...
argglobal
%argdel
edit ~/dotfiles/nvim-test/.config/nvim-test/lua/config/keymaps.lua
argglobal
balt ~/dotfiles/nvim-malo/.config/nvim-malo/lua/keymaps.lua
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
silent! normal! zE
let &fdl = &fdl
let s:l = 83 - ((18 * winheight(0) + 20) / 40)
